...
//data source = data
//delegate = manage cell selection, row heights, and other aspects related to displaying the data
...
class MealTableViewController: UITableViewController {
    ...
    //MARK: Properties
   // declares a property on MealTableViewController and initializes it with a default value (an empty array of Meal objects).
    var meals = [Meal]()
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return meals.count //num of rows = num of meals
    }
